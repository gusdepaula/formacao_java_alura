...
public class Principal {
    ...
    private void buscarEpisodioPorSerie(){
        ...
        if(serie.isPresent()) {
            ...
            System.out.println("Série não encontrada entre as buscadas.");
        }
    }
    ...
    private void buscarSeriesPorAtor() {
        System.out.println("Digite o nome do ator para busca de séries: ");
        var nomeAtor = leitura.nextLine();
        System.out.println("Avaliacao mínima para busca: ");
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Digite o gênero para busca de séries: ");
    ...
    private void buscarEpisodioPorTrecho() {
        ...
        episodiosEncontrados.forEach(e ->
                System.out.printf("Série: %s - Episódio %s - Avaliação %s %s\n",
